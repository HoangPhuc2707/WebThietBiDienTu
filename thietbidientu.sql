...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 17, 2024 lúc 05:34 AM
...
INSERT INTO `donhang` (`id_dh`, `madh`, `tongdh`, `phuongthucthanhtoan`, `id_user`, `address`, `sdt`, `duyetdh`) VALUES
(59, 'QPQ311367', 7.49, 1, 2, '274-Khu phố 4-Thị Trấn Thứ Ba-An Biên-Kiên Giang', 917861848, 0),
(60, 'QPQ19707', 161.98, 1, 6, '274-Khu phố 4-Thị Trấn Thứ Ba-An Biên-Kiên Giang', 388766756, 0),
(61, 'QPQ572471', 85.95, 1, 2, '274-Khu phố 4-Thị Trấn Thứ Ba-An Biên-Kiên Giang', 388766756, 1);
...
INSERT INTO `giohang` (`id_giohang`, `id_dh`, `id_sp`, `soluong`, `dongia`, `tensp`, `hinhanh`) VALUES
(23, 59, '1003', 1, 7.49, 'Samsung Galaxy A34 5G SILVER', 'samsunggalaxya345gsilver.jpeg'),
(24, 60, '2001', 2, 14.99, 'MTXT Dell Latitude 3420 Core i5', 'mtxtdelllatitude3420.jpg'),
(25, 60, '4006', 6, 22, 'Tai nghe Jellico Heavy Bass Earphone CT19', 'TN-day-Jellico-CT19-6.jpg'),
(26, 61, '1001', 1, 19.99, 'iPhone 15 Xanh Dương 128GB', 'iphone15xanhduong128gb.jpeg'),
(27, 61, '1005', 2, 9.99, 'Samsung Galaxy A55 5G 8/128GB', 'A55-navy1.jpg'),
(28, 61, '2001', 1, 14.99, 'MTXT Dell Latitude 3420 Core i5', 'mtxtdelllatitude3420.jpg'),
(29, 61, '1002', 1, 30.99, 'iPhone 15 Pro Max Titan Tự Nhiên 256GB', 'iphone15promaxtitantunhien256gb.jpeg');
...
('1001', 'iPhone 15 Xanh Dương 128GB', 19.99, '1', 'iphone15xanhduong128gb.jpeg', '<p>*Mô tả:</p>\r\n                    <p>1. Mặt lưng dễ dàng tháo lắp: Mặt lưng của iPhone 15 Pro Max đã được thiết kế lại để dễ dàng tháo\r\n                        lắp, giúp quá trình sửa chữa trở nên tiện lợi hơn. </p>\r\n                    <p>2. Khung viền bo tròn hơn: Điện thoại iPhone 15 Pro Max với các góc cạnh được bo cong hơn so với \r\n                        phiên bản tiền nhiệm, mang tới tổng thể thiết kế liền mạch và hạn chế được phần lớn cảm giác cấn\r\n                         tay khi cầm. Các góc bo tròn cũng giúp giảm áp lực lên ngón tay khi người dùng cầm điện thoại \r\n                         trong một thời gian dài.</p>\r\n                    <p>3. Nút Action đa dạng tính năng tùy chọn: Nút Action là một trong những trang bị hoàn toàn mới thay\r\n                         thế cho cần gạt rung trên iPhone 14 Pro Max. Action Button có thể hỗ trợ tới 9 tính năng khác\r\n                          nhau thay vì chỉ một tính năng Im lặng như cần gạt rung. </p>'),
...
(2, 'Kiên Giang', 'thphuc@gmail.com', 'phuc', '1', 0, 835593990),
(6, 'Đồng Tháp', 'aa@gmail.com', 'quang', '1', 0, 388766756);
...
--
ALTER TABLE `donhang`
  MODIFY `id_dh` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT cho bảng `giohang`
--
ALTER TABLE `giohang`
  MODIFY `id_giohang` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
